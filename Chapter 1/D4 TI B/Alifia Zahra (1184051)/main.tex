...
\begin{enumerate}
    ...
    \item Lalu pilih environment variables
            \paragraph{}
            \centerline{\includegraphics[width=8cm]{image/envirvar.png}}
    \item Pilih path Anaconda, lalu klik edit
        \begin{figure}[h]
            \centerline{\includegraphics[width=8cm]{image/pathanac.png}}
        \end{figure}
        \begin{figure}[h]
            \centerline{\includegraphics[width=8cm]{image/pathokeh.png}}
        \end{figure}
\end{enumerate}
